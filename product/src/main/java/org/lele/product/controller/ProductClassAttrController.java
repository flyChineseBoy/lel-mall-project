...
public class ProductClassAttrController extends ApiController {
     ...
     */
    @GetMapping
    public CommonResult selectAll(@ApiIgnore Page<ProductClassAttr> page, ProductClassAttr productClassAttr) {
        return CommonResult.success(this.productClassAttrService.page(page, new QueryWrapper<>(productClassAttr)));
    }
    ...
    public CommonResult selectOne(@PathVariable Serializable id) {
        return CommonResult.success(this.productClassAttrService.getById(id));
    }
    ...
    @ApiOperation("新增商品属性")
    @PostMapping
    public CommonResult insert(@RequestBody ProductClassAttr productClassAttr) {
        return CommonResult.success(this.productClassAttrService.save(productClassAttr));
    }
     ...
     */
    @PutMapping
    public CommonResult update(@RequestBody ProductClassAttr productClassAttr) {
        return CommonResult.success(this.productClassAttrService.updateById(productClassAttr));
    }
